...
var food;
var rabbit;
var starimg, emptystar,twostar,onestar;
var star,startwo;
...
function setup() 
{
  ...
  ground = new Ground(250,height,1200,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(120,530,100,100);
  bunny.scale = 0.2;
 ...
 star=createSprite(325,50,20,20)
 star.addImage(starimg)
 star.scale = 0.03
 

 stardisplay=createSprite(100,50,30,30)
 ...
 startwo=createSprite(100,310,20,20)
 startwo.addImage(starimg)
 startwo.scale = 0.03

 blower=createSprite(320,400,20,20)
...
function draw() 
{
  ...
  if(collides(fruit,startwo,20)==true)
  {
